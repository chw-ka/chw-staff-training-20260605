...
| **格式來源** | `minutes-template.md` | 上學年紀錄 `.docx`（跟版面、欄位、語氣） |
...
見 [`handouts/prompt-cheatsheet.md`](../../handouts/prompt-cheatsheet.md) 第二、三步。

**第二步：**
```
@.cursor/skills/meeting-minutes/SKILL.md
請讀 @sample-meeting-transcript.txt、@議程_視藝科組會_20260528.docx、@minutes-template.md，
