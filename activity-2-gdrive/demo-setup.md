...
喺 [Google Drive](https://drive.google.com)：
...
- 左：Cursor Agent
- 右：Chrome → drive.google.com → 開住 `CHW_Training_垃圾崗`

## 講者 wow 演示順序

1. 展示垃圾崗 4 個亂碼檔
2. 貼主推 Prompt
3. **慢動作** Approve 第一個 `listFolder` — 解釋 Agent 睇緊雲端
4. Approve `createFolder` — 叫老師睇 Drive 左欄
